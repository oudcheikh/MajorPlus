...
const C1 = () => {
    ...
    return (
        <Container>
            ...
            <img src={"/images/Images/Food.png"} alt="Teacher" style={imageStyle} />
            <Card>
            ...
            {section >= 2 && (
                <div>
                    ...
                    <img src={"/images/Images/Lait.png"} alt="Lait" style={imageStyle} />
            ...
            {section >= 5 && (
                <div>
                    <Card>
                        ...
                        <img src={"/images/Images/proteines.png"} alt="protéines" style={imageStyle} />
                        <FormulaText>
                            <strong>Viandes :</strong> chameau, mouton, chèvre.<br></br>
