...
const C1 = () => {
    ...
    return (
        <Container>
            ...
            <img src={"/images/Images/EauEtSante.png"} alt="EauEtSante" style={imageStyle} />
            <Card>
            ...
            {section >= 2 && (
                <div>
                    ...
                    <Card>
                        ...
                        <br></br>
                        <img src={"/images/Images/dysenterie.png"} alt="dysenterie" style={imageStyle} />
                        <FormulaText>
            ...
            {section >= 3 && (
                <div style={{ marginBottom: '50px', width: '100%' }}>
                    ...
                    <Card>  <FormulaText> <strong>2. Les parasitoses intestinales </strong></FormulaText>
                        <img src={"images/Images/parasites.png"} alt="parasites" style={imageStyle} />
                        <FormulaText>
            ...
            {section >= 4 && (
                <div style={{ marginBottom: '50px', width: '100%' }}>
                    <Card>
                        ...
                        <img src={"/images/Images/Guinea.png"} alt="Guinea" style={imageStyle} />
                        <FormulaText>
            ...
            {section >= 5 && (
                <div>
                    <Card>
                        ...
                        <img src={"/images/Images/bilharziose.png"} alt="bilharziose" style={imageStyle} />
                        <FormulaText>
            ...
            {section >= 6 && (
                <div>
                    <Card>
                        ...
                        <img src={"/images/Images/Paludisme.png"} alt="Paludisme" style={imageStyle} />
                        <FormulaText>
