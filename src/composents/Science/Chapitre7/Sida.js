...
const C1 = () => {
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 7 : Le sida et VIH</strong></FormulaText>
                  ...
                  <img src={"/images/Images/Sida.png"} alt="Teacher" style={imageStyle} /> 
                  <Card>
 ...
 <img src={"/images/Images/sida1.png"} alt="image sida" style={imageStyle} /> 
...
{section >= 2 && (
                <div style={{ marginBottom: '50px', width: '100%' }}>
                    ...
                    <img src={"/images/Images/Virus1.png"} alt="Lait" style={imageStyle} /> 
...
<Card>  <FormulaText><strong>Comment savoir si une personne est malade du sida ?</strong></FormulaText>    
                        <img src={"images/Images/malade.png"} alt="glucides" style={imageStyle} /> 
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"images/Images/vaccination.png"} alt="Sources de lipides" style={imageStyle} /> 
  ...
  <Audio/>
    ...
    <img src={"/images/Images/doctor.png"} alt="Sources de lipides" style={imageStyle} /> 
