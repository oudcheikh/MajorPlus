...
import { Orange_NumberDisplay, imageStyle_Mot_Clé, imageStyle_Important, Beige_NumberDisplay, Vert_Fancee_NumberDisplay, middle_Green_NumberDisplay, Green_NumberDisplay, NumberDisplay, Card, BodyText, FormulaText, ContinueButton, Container_Progress_Bar, SectionContainer2, FormulaBox2, SwipeContainer2, Swipe_Section } from "../../../Styles/MajorStyles";
            ...
            <StyledBox>
                <SwipeContainer2 onScroll={handleScroll}>
                    <Swipe_Section ref={section1Ref}>
                        <SectionContainer2>
                            <FormulaBox2>
                                <Acceuil titre={" Comparer et ordonner des nombers"} imgSrc={"/images/Math/C/C2/comp1.png"} altText={"Comparer et ordonner des nombers"}>
                                    {" "}
                                </Acceuil>
                    ...
                    <Swipe_Section ref={section2Ref}>
                        <SectionContainer2>
                            <FormulaBox2>
                                ...
                                <Beige_NumberDisplay>
                                    <strong>C'est déterminer lequel est le plus grand, le plus petit ou s'ils sont égaux.</strong>
                                </Beige_NumberDisplay>
                                ...
                                <Card>
                                    ...
                                    <FormulaText>
                                        <strong>
                                            {" "}
                                            <span style={{ color: "blue" }}>Astuce : </span>
                    ...
                    <Swipe_Section ref={section3Ref}>
                        <SectionContainer2>
                            <FormulaBox2>
                                ...
                                <FormulaText>
                                    <strong> Ordre dècroissant </strong>
                                </FormulaText>
