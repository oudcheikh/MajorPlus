    ...
    return (
        <div>
            ...
            <table style={tableStyle}>
                <thead>
                    <tr>
                        <th colSpan="3" className="header-group-1" style={headerStyle}>
                            milliards
                        </th>
                        <th colSpan="3" className="header-group-2" style={headerStyle}>
                            millions
                        </th>
                        <th colSpan="3" className="header-group-3" style={headerStyle}>
                            milliers
                        </th>
                        <th colSpan="3" className="header-group-4" style={headerStyle}>
                            unités
                        </th>
                    </tr>
                    <tr>
